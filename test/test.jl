...
# using BEASTXMLConstructor, Random, BEASTTreeUtils, CSV, DataFrames, JLD
...
# iid_prior = PhylogeneticFactorAnalysis.IIDPrior("orthogonal")

# shrinkage_msp = PhylogeneticFactorAnalysis.ModelSelectionProvider([3, 3, 3], [10.0, 100.0, 1000.0], 2)
# shrinkage_prior = PhylogeneticFactorAnalysis.ShrinkagePrior("shape", true, false, true)
...
# PhylogeneticFactorAnalysis.write_jld("iid.jld", iid_input)
# PhylogeneticFactorAnalysis.write_jld("shrink.jld", shrink_input)
...
#     iid_input.tasks.plot_factors = false
#     PhylogeneticFactorAnalysis.run_pipeline(iid_input)
# catch e
